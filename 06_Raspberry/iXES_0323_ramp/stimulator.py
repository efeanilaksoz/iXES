...
class Stimulator:
    ...
    def reconnect(self):
        ...
        try:
            self.serial_port = serial.Serial(port=serial.PortNotOpenError, baudrate=115200, bytesize=serial.EIGHTBITS, parity=serial.PARITY_NONE, stopbits=serial.STOPBITS_TWO, rtscts=True)
        except:
            traceback.print_exc()
            return False
