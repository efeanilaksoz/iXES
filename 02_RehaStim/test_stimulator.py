...
def runExamples():
    ...
    config_dict1 = {
        'port': '/dev/tty.usbserial-HMSIWVLN',
        'channel_stim': [],
        'channel_lf': [],
        'n_factor': 0,
        'ts1': 20,
    ...
    stim_manager.single_pulse(channel_number = 1, pulse_width = 200, pulse_current = 120)
...
def run():
    ...
    key = input("press enter to run, 's' to skip")
    while key != 's' and key != 'q':
        ...
        key = input("press enter to rerun test 1, 'q' to quit")
    ...
    while key != 's' and key != 'q':
        ...
        key = input("press enter to re-run test 2, 'q' to quit")
